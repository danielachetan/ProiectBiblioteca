...
public class Validator {
    ...
    public static void validateCarte(Carte c) throws Exception {
        ...
        if (!isOkYear(c.getAnAparitie()))
            throw new Exception("Anul aparitiei este mai mare decat anul curent!");
    }
    ...
    private static Boolean isOkYear(String s) {
        if (Integer.parseInt(s) > LocalDateTime.now().getYear())
            return false;
